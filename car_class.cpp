...
//Build the class for car containing 4 fields.
class car {
    string make;
    string car_model;
    string year;
...
public:
    ...
    //The empty constructor for the car.
    car() {
    }

    //The destructor for the car.
    ~car() {
    }

    //reads and stores the 10 records from file into an a array of objects.
    ...
    // prints out the car records in the array.
    ...
    //sorts the records in ascending order based on
    //the year field.
    ...
    //return all cars for a specific make. It should
    //return “No Records found” if no cars exist.
